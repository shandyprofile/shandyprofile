    ...
    function radar(selection) {
      selection.each(function(data) {
        ...
        // styles should only be transitioned with css
            .style('stroke', function (d, i) { return colordefault; })
            .style('fill', function (d, i) { return colordefault; })
        .transition().duration(cfg.transitionDuration)
        // svg attrs with js
        ...
        if(cfg.circles && cfg.radius) {
          ...
          // styles should only be transitioned with css
              .style('fill', function (d) { return colordefault; })
          .transition().duration(cfg.transitionDuration)
          // svg attrs with js
          .attr('r', cfg.radius)
          .attr('cx', function(d) {
